...
# Default arguments
packageUrl="https://github.com/vpnhood/VpnHood/releases/download/v7.8.805/VpnHoodClient-linux-arm64.tar.gz";
versionTag="v7.8.805";
assemblyName="VpnHoodClient";
productName="VpnHood! CLIENT";
launcher="vhclient";
